        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form method="POST" action="{{ route('admin.caretakers.update', $caretaker) }}">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="name" class="block mt-1 w-full" type="text" name="name" :value="old('name', $caretaker->name)" required autofocus />
                            ...
                            <div>
                                ...
                                <x-text-input id="email" class="block mt-1 w-full" type="email" name="email" :value="old('email', $caretaker->email)" required />
                            ...
                            <div>
                                ...
                                <x-text-input id="username" class="block mt-1 w-full" type="text" name="username" :value="old('username', $caretaker->username)" required />
                            ...
                            <div>
                                ...
                                <x-text-input id="phone" class="block mt-1 w-full" type="text" name="phone" :value="old('phone', $caretaker->phone)" required />
                            ...
                            <div>
                                ...
                                <x-text-input id="address" class="block mt-1 w-full" type="text" name="address" :value="old('address', $caretaker->address)" required />
                            ...
                            <div>
                                ...
                                <select id="shelter_id" name="shelter_id" class="block mt-1 w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm">
                                    ...
                                    @foreach ($shelters as $shelter)
                                        <option value="{{ $shelter->id }}" {{ (old('shelter_id', $caretaker->shelter_id) == $shelter->id) ? 'selected' : '' }}>
                                            {{ $shelter->name }}
                                        </option>
                                    @endforeach
                                </select>
